...
Each .py file includes the necessary functions and scripts it requires, with detailed comments provided for each function.
...
%% selectivity_during_transitions.py: 
